...
- **Anonymous Community**: Integrated Cusdis comments for a lightweight, login-free, and anonymous user experience.
...
## Current Plan & Steps
1.  **Switch to Cusdis**: Replace Disqus with Cusdis for simpler, anonymous comments.
...
4.  **Define Structure (`index.html`)**: Update layout to include the theme toggle, inquiry form, and Cusdis thread.
5.  **Apply Styles (`style.css`)**: Implement transitions, light mode theme overrides, form styling, and comment section spacing.
